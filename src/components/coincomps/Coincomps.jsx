...
const Spinner = () => (
  <div className="flex items-center justify-center space-x-2">
    ...
    <span className="text-white text-[20px] md:text-[30px] lg:text-[40px]">
      Connecting <span className="ellipsis"></span>{" "}
    </span>
  </div>
);
        ...
        <div data-aos="fade-up" data-aos-duration="2000">
          <div className="grid gap-y-[35px]">
            {data.map((item) => (
              <div
                key={item.id}
                className="flex items-center px-[20px] py-[20px] md:w-[80%] rounded shadow-2xl cursor-pointer"
